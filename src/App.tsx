...
export default function App() {
  ...
  const [imgSrc, setImgSrc] = useState("/src/assets/images/janneke_pasfoto.jpg");
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-legal-navy/80 leading-relaxed text-sm md:text-base">
              ...
              <p>
                Er wordt geadviseerd en geprocedeerd over vrijwel alle aspecten binnen het vastgoedrecht en huurrecht. Door de jarenlange ervaring wordt er snel en efficiënt gewerkt.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-16 gap-y-16">
                ...
                >
                  ...
                  <div className="text-sm font-medium leading-relaxed opacity-90">
                    Toegankelijke en persoonlijke begeleiding waarbij de belangen van de cliënt het uitgangspunt vormen. Met korte lijnen en een op de situatie toegesneden ondersteuning.
                  </div>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
